...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath: '../skin/i/nicEditorIcons.gif',
...
var nicUploadButton = nicEditorAdvancedButton.extend({
	...
	addPane: function () {
		...
		this.removePane();
		console.log(B.messages.list[0].imgName);
		var D = B.messages.list[0].imgName;
		if (!this.im) {
			this.ne.selectedInstance.restoreRng();
